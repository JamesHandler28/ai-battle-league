...
ALL_BOTS = [
    # TEAM BIKINI BOTTOM (PINK) ["Spongebob", "Patrick", "Squidward", "Mr. Krabs"]
    ...
    # TEAM MUSHROOM KINGDOM (RED) ["Mario", "Luigi", "Bowser", "Peach"]
    ...
    # TEAM SPRINGFIELD (YELLOW) ["Homer", "Bart", "Lisa", "Marge"]
    ...
    # TEAM DC (BLACK) ["Superman", "Batman", "Flash", "Wonder"]
    ...
    # TEAM PEANUTS (ORANGE) ["Charlie B", "Snoopy", "Lucy", "Woodstock"]
